...
\renewcommand{\familydefault}{\sfdefault}
  ...
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      citecolor=blue,%
      unicode,%
      pdftitle={Administración Mundial},%
      pdfsubject={}%
    }
...
\input{class_continentes}
\input{class_pais}
\input{class_pais_en_desarrollo}
\input{class_pais_primer_mundo}
\input{class_planeta}
\chapter{Documentación de archivos}
\input{main_8cpp}
\input{_mundo_8cpp}
\input{_mundo_8hpp}
\input{_mundo_8hpp_source}
